...
const message = {
    ...
    setting: {
        ...
        proxyHelper1: '應用商店的索引同步、圖示/編排下載與安裝包下載',
        proxyHelper2: '系統版本升級（版本檢查、更新說明與升級包下載）',
        proxyHelper3: '申請憑證（ACME 帳號註冊/憑證訂單與 ZeroSSL EAB 取得）',
        proxyType: '代理類型',
        proxyDisable: '不啟用',
        proxyOptional: '選填',
        proxyUser: '使用者名稱',
        proxyRememberPwd: '記住密碼',
        proxyPasswdUnchanged: '留空則保持原密碼不變',
        proxyTest: '測試連線',
